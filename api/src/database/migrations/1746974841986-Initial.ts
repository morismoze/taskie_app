...
export class Initial1746974841986 implements MigrationInterface {
    name = 'Initial1746974841986'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."task_assignments_status_enum" AS ENUM('0', '1', '2', '3')`);
        await queryRunner.query(`CREATE TABLE "task_assignments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "status" "public"."task_assignments_status_enum" NOT NULL DEFAULT '0', "task_id" uuid, "assignee_id" uuid, CONSTRAINT "PK_b68f42cf36d807d8a19a96066d7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tasks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "title" character varying NOT NULL, "reward_points" smallint NOT NULL, "description" character varying, "due_date" TIMESTAMP, "workspace_id" uuid, "created_by_id" uuid, CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."goal_status_enum" AS ENUM('0', '1', '2', '3')`);
        await queryRunner.query(`CREATE TABLE "goal" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "title" character varying NOT NULL, "description" character varying, "required_points" integer NOT NULL, "status" "public"."goal_status_enum" NOT NULL DEFAULT '0', "assignee_id" uuid, "workspace_id" uuid, "created_by_id" uuid, CONSTRAINT "PK_88c8e2b461b711336c836b1e130" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."workspace_user_workspace_role_enum" AS ENUM('0', '1')`);
        await queryRunner.query(`CREATE TYPE "public"."workspace_user_status_enum" AS ENUM('0', '1')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_064b7d356fc48de006081a50b2" ON "workspace_user" ("workspace_role") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."workspace_invite_status_enum" AS ENUM('0', '1')`);
        await queryRunner.query(`CREATE TABLE "workspace_invite" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "token" character varying NOT NULL, "expires_at" TIMESTAMP NOT NULL, "status" "public"."workspace_invite_status_enum" NOT NULL DEFAULT '0', "workspace_id" uuid, "invited_by_id" uuid, "used_by_id" uuid, CONSTRAINT "PK_731c4e491678e81c9dce6df62cb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "task_assignments" ADD CONSTRAINT "FK_b389f4488d0a8241c3c98273966" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_assignments" ADD CONSTRAINT "FK_5fbb07753ef37a59017937f9512" FOREIGN KEY ("assignee_id") REFERENCES "workspace_user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tasks" ADD CONSTRAINT "FK_5cb6ca4667dfa947871694da959" FOREIGN KEY ("workspace_id") REFERENCES "workspace"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "task_assignments" DROP CONSTRAINT "FK_5fbb07753ef37a59017937f9512"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_064b7d356fc48de006081a50b2"`);
